...
//    register<ShadowJar>("devBundleJar") {
//        from(sourceSets["main"].output)
//        from(projectCore.tasks["devJar"])
//        configurations = listOf(
//            project.configurations.runtimeClasspath.get(),
//            projectCore.configurations.runtimeClasspath.get()
//        )
//        exclude { it.file in projectCore.tasks.jar.get().outputs.files }
//        exclude { it.file in projectCore.tasks["devJar"].outputs.files }
//
//        exclude("reobf-plugin.yml")
//        rename("dev-plugin.yml", "plugin.yml")
//
//        doLast {
//            copy {
//                from(archiveFile)
//                into(rootProject.file(".server/plugins-dev"))
//            }
//        }
//    }
//
//    register<ShadowJar>("reobfBundleJar") {
//        from(sourceSets["main"].output)
//        from(projectCore.tasks["reobfJar"])
//        configurations = listOf(
//            project.configurations.runtimeClasspath.get(),
//            projectCore.configurations.runtimeClasspath.get()
//        )
//        exclude { it.file in projectCore.tasks.jar.get().outputs.files }
//
//        exclude("dev-plugin.yml")
//        rename("reobf-plugin.yml", "plugin.yml")
//
//        doLast {
//            copy {
//                from(archiveFile)
//                into(rootProject.file(".server/plugins-reobf"))
//            }
//        }
//    }
//
//    register<Jar>("clipJar") {
//        from(sourceSets["main"].output)
//
//        exclude("dev-plugin.yml")
//        rename("reobf-plugin.yml", "plugin.yml")
...
//            copy {
//                from(archiveFile)
//                into(rootProject.file(".server/plugins-clip"))
//            }
//        }
//    }
}
